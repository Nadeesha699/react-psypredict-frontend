        ...
        <>
          ...
          <div className="w-1/4 flex flex-col gap-5">
            ...
            <p className="text-white text-justify">
              ...
              Common symptoms may include persistent cough, chest pain,
            ...
            <p className="text-white text-justify">
              ...
              improve outcomes. Our tool helps assess your potential risk by
              analyzing your health and lifestyle data.
            </p>
          </div>
        </>
      )}
